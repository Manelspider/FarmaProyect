#!/bin/bash
# Script para crear todas las migraciones separadas por tabla

# 0002: UserRole
cat > 0002_create_tbl_user_roles.py << 'EOF'
...
# 0003: User
cat > 0003_create_tbl_users.py << 'EOF'
...
# 0004: UserData
cat > 0004_create_tbl_user_data.py << 'EOF'
...
# 0005: Pharmacy
cat > 0005_create_tbl_pharmacy.py << 'EOF'
...
# 0006: PharmacyData
cat > 0006_create_tbl_pharmacy_data.py << 'EOF'
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('pharmacy', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='pharmacy_data', to='core.pharmacy')),
...
# 0007: PharmacyUser
cat > 0007_create_tbl_pharmacy_users.py << 'EOF'
...
# 0008: NotificationType
cat > 0008_create_tbl_notification_types.py << 'EOF'
...
# 0009: Notification
cat > 0009_create_tbl_notifications.py << 'EOF'
...
# 0010: NotificationMessage
cat > 0010_create_tbl_notification_messages.py << 'EOF'
